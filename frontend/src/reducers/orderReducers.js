...
export const orderListMyReducer = (state= { orders:[] },action) => {
    switch(action.type){
        case orderActions.ORDER_LIST_MY_REQUEST:
             return{
                 loading: true
             }
        case orderActions.ORDER_LIST_MY_SUCCESS:
            return {
                loading:false, 
                orders:action.payload  
            }
        case orderActions.ORDER_LIST_MY_FAIL:
            return{
                loading: false,
                error: action.payload,
            }
        case orderActions.ORDER_LIST_MY_RESET:
            return{
                orders:[]
            }
        default:
